...
const CONSECUTIVE_TRIPLETS = [
  ['slot1', 'slot2', 'slot3'], // Midnight + Sunrise + Breakfast (12AM-12PM = 12 hours)
  ['slot2', 'slot3', 'slot4'], // Sunrise + Breakfast + Lunch (3AM-4PM = 13 hours)
  ['slot3', 'slot4', 'slot5'], // Breakfast + Lunch + Afternoon (8AM-8PM = 12 hours)
  ['slot4', 'slot5', 'slot6'], // Lunch + Afternoon + Dinner (12PM-12AM = 12 hours)
  ['slot5', 'slot6', 'slot1'], // Afternoon + Dinner + Midnight (4PM-3AM = 11 hours)
  ['slot6', 'slot1', 'slot2'], // Dinner + Midnight + Sunrise (8PM-8AM = 12 hours)
];
